...
src/effects/presets/     — Built-in effect presets (frequency, hopf, nebula, starfield, blackhole, storm, clifford-torus, perlin-noise, electromagnetic, hyperflower, fireflies, murmuration, axiom, spirit, paper-fleet, text-wave, text-scatter, text-dissolve, text-terrain)
...
- [x] **Phase 4.095**: The Spirit — GPGPU curl noise particle simulation by Edan Kwan (MIT License, https://github.com/edankwan/The-Spirit). Ported as custom renderer with FBO ping-pong simulation, 4D simplex noise derivatives, 3-octave curl noise field, triangle + point particle rendering, floor + lights + fog + shadows. 65k particles (256×256 texture). Controls: Speed, Die Speed, Radius, Curl Size, Attraction, Triangles/Points toggle, Follow Mouse, Shadow. Bloom enabled. Effect count: 21 presets.
