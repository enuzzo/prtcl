...
const SHOWCASE_EFFECTS: ShowcaseEffect[] = [
  {
    ...
    category: 'Math',
    particles: '24K',
    description: 'A recursive waveform that pulses whether you deserve it or not. Now it sparkles on the crests too.',
  ...
  },
  {
    ...
    category: 'Organic',
    particles: '16K',
    description: 'Three rules, sixteen thousand starlings, one emergent hallucination.',
  ...
  },
  {
    ...
    category: 'Math',
    particles: '20K',
    description: 'Charge packets sprinting pole to pole, auroras where they land.',
    embedParams: '&rotate=0.4&orbit=0&badge=0',
    span: 'short',
  },
  {
    id: 'hopf-fibration',
