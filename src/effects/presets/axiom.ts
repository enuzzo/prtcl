...
export const axiom: Effect = {
  ...
  slug: 'axiom',
  name: 'Axiom',
  description: 'Agents hunting minima on a landscape that shifts under them. Gradient descent dressed up as philosophy. Nothing here is actually being optimized.',
  author: 'PRTCL Team',
  category: 'abstract',
  ...
  pointSize: 0.93,
  cameraDistance: 8,
  cameraPosition: [3.271, 0.862, -3.755],
  cameraTarget: [-0.013, -0.29, -0.005],
  autoRotateSpeed: 0,
  cameraZoom: 1,
