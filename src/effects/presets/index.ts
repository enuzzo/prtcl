...
import { theSpirit } from './the-spirit'
import { volumetricFlow } from './volumetric-flow'
...
export const ALL_PRESETS: Effect[] = [frequency, hopf, nebula, insideNebula, starfield, blackhole, storm, cliffordTorus, electromagnetic, perlinNoise, hyperflower, fireflies, murmuration, axiom, paperFleet, iridescence, theSpirit, volumetricFlow, textWave, textScatter, textDissolve, textTerrain]
