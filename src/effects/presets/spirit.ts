 ...
 *
 * Controls match original dat.GUI exactly:
 * Simulator: dieSpeed, radius, attraction, followMouse
 * Rendering: shadowDarkness, useTriangleParticles
 */
...
var fm = addControl('followMouse', 'Follow Mouse', 0, 1, 0);
